...
import { calculateSupportedWithdrawingMethods, getRelatedAssetByWithdrawMethod } from "./index";
...
describe("calculateSupportedWithdrawingMethods", () => {
  ...
  it("should include withdrawToStata when stataToken is available", () => {
    ...
    expect(calculateSupportedWithdrawingMethods(assets)).toEqual(["withdrawToUnderlying", "withdrawToStata"]);
  });
  ...
  it("should include withdrawToAave when aToken is available", () => {
    ...
    expect(calculateSupportedWithdrawingMethods(assets)).toEqual(["withdrawToUnderlying", "withdrawToAave"]);
  });
