...
export const UmbrellaTable = ({ data, assets }: UmbrellaTableProps) => {
  ...
  const TableHead = (
    <div className="bg-main-600 dark:bg-main-900 dark:border-main-500 border-main-950 grid md:grid-cols-[1fr_80px_100px_160px_60px] lg:grid-cols-[1fr_80px_120px_160px_160px] gap-4 border-t md:px-4 lg:px-[30px] py-3 text-white">
