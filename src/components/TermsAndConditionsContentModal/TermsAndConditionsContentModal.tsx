        ...
        <Block elevation={isMobile ? 1 : 2} className="relative not-md:px-6 not-md:py-5">
          ...
          <div className="mx-auto flex w-full flex-col gap-4 not-md:text-base md:max-w-[728px] md:gap-6 md:pt-14 md:pb-[80px]">
            ...
            <p>
              ...
              Agreement, and that you have the legal capacity to enter into a binding agreement with BGD Labs Technology
              LLC. If you do not meet the eligibility requirements to enter into a binding agreement, you must not
            ...
            <ul className="list-disc">
              ...
              <li className="ml-8">
                <strong>Aave Safety Module (Umbrella):</strong> A safety and protection mechanism designed to safeguard
                user assets.
              </li>
              <li className="ml-8">
              ...
              <li className="ml-8">
                <strong>Supplementary Tools and Infrastructure:</strong> A range of additional tools and infrastructure
                developed to support the overall functionality of the protocol.
              </li>
            </ul>
            <h2 className="font-bold">7. Description of our interface</h2>
            <p>
              The Aave Umbrella interface is a software application that allows users to build transactions to interact
              with the Umbrella smart contracts deployed by the Aave DAO. These transactions are then submitted by the
              user via their own blockchain wallet. Through the interface, users can build Umbrella transactions for the
              following:
            </p>
            <ul className="list-disc">
            ...
            <ul className="list-disc">
              <li className="ml-8">
                ...
                Additionally, you are representing that you possess the necessary financial and technical sophistication
                to appreciate the risks associated with using cryptographic and blockchain-based systems, and that you
                have a practical understanding of the complexities and usage of digital assets.
              </li>
              <li className="ml-8">
                You have a comprehensive understanding of the functionality and mechanics of the smart contracts, which
              ...
              <li className="ml-8">
                You understand the concept of slashing on the Aave Umbrella smart contracts, by which users lose staked
                funds for those smart contracts to cover a loss on the Aave Protocol.
              </li>
              <li className="ml-8">
              ...
              <li className="ml-8">
                You understand that the user interface interacting with the Umbrella smart contracts is software that is
                completely independent of the smart contracts themselves.
              </li>
              <li className="ml-8">
              ...
              <li className="ml-8">
                It&apos;s paramount to grasp that digital asset markets can be volatile due to various reasons, such as
                market adoption, speculative tendencies, technological evolution, security protocols, and legal
              ...
              <li className="ml-8">
                ...
                dynamics, on-chain governance, and third-party infrastructure—outcomes are inherently unpredictable. As
                such, no specific results or performance guarantees are provided when using the interface.
              </li>
              <li className="ml-8">
                We neither own nor exert control over any of the digital assets or the foundational blockchains involved
                in transactions via the Services. Thus, we cannot be held accountable for losses you might sustain while
                using the Service, particularly losses arising from software malfunctions, system downtimes, or
            ...
            <p>
              ...
              users through their own self-custodial wallets. BGD Labs Technology has no access to, or control over, any
              user assets or transaction execution. You are solely responsible for managing your own wallet, securing
              your private keys, and reviewing the accuracy and security of any transactions you authorize.
            </p>
            ...
            <p>
              ...
              focused on providing software development and security services to the Aave DAO, including the design and
              implementation of smart contract systems such as Umbrella.
            </p>
            ...
            <p>
              ...
              associated with their use of the Aave Umbrella interface, including but not limited to taxes, duties, and
              assessments claimed or imposed by any governmental authority. This responsibility includes taxes payable
              as a result of interacting with smart contracts and recovering the assets.
            </p>
            <p>
            ...
            <p>
              ...
              assets, activate cooldowns, claim rewards, and withdraw funds by interacting with the Aave Umbrella smart
              contracts deployed by the Aave DAO. The interface is not intended to provide, and should not be considered
              as, financial or investment advice or services. BGD Labs Technology is not a financial institution and
              does not provide any financial or investment services through the interface. The interface with the Aave
              Umbrella smart contracts is not intended to be used for any financial or investment purposes.
            </p>
            ...
            <p>
              ...
              functionality, or availability of any third-party services, and users assume all risks associated with the
              use of such services. BGD Labs Technology is not responsible for any losses, damages, or liabilities
            ...
            <p>
              To access and use the Aave Umbrella interface, you must comply with this Agreement, applicable third-party
              policies, and all applicable laws, rules, and regulations. The following conduct is strictly prohibited:
            </p>
            <ul className="list-disc">
              <li className="ml-8">
                Using the Aave Umbrella interface to engage in or facilitate illegal activities, including but not
                limited to money laundering, terrorism financing, tax evasion, or any activity in violation of sanctions
              ...
              <li className="ml-8">
                ...
                any other type of malicious code that will or may be used in any way that will affect the functionality
                or operation of the Aave Umbrella interface;
              </li>
              <li className="ml-8">
                Attempting to or actually copying or making unauthorized use of all or any portion of the Aave Umbrella
                interface, including by attempting to reverse compile, reformatting or framing, disassemble, reverse
                engineer any part of the Aave Umbrella interface;
              </li>
              <li className="ml-8">
              ...
              <li className="ml-8">
                Engaging in conduct that could jeopardize the security or functionality of the Aave Umbrella interface,
                or deceive or defraud other users.
              </li>
              <li className="ml-8">
                Transacting in items that infringe intellectual property rights, including but not limited to copyrights
                or trademarks;
              </li>
              <li className="ml-8">
              ...
              <li className="ml-8">
                ...
                other sanctions authority in any applicable jurisdiction. This includes if you, your wallet address, or
                your affiliated entity appears on any sanctions list such as the Specially Designated Nationals and
                ...
                solely responsible for complying with all laws and regulations applicable to your jurisdiction, and BGD
                Labs shall not be liable for your failure to do so.
              </li>
            </ul>
            ...
            <p>
              You acknowledge that these Terms do not grant you any intellectual property rights whatsoever in the Aave
              Umbrella interface or related software. All rights are reserved by the Aave DAO, subject to the license
            ...
            <p>
              ...
              STATUTORY. WE SPECIFICALLY DISCLAIM ALL IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A PARTICULAR
              PURPOSE. YOU ACKNOWLEDGE AND AGREE THAT YOUR USE OF OUR PRODUCTS IS AT YOUR OWN RISK. WE DO NOT GUARANTEE
              THAT ACCESS TO ANY OF OUR PRODUCTS WILL BE CONTINUOUS, UNINTERRUPTED, TIMELY, OR SECURE; THAT THE
              INFORMATION CONTAINED IN ANY OF OUR PRODUCTS WILL BE ACCURATE, RELIABLE, COMPLETE, OR CURRENT; OR THAT ANY
              OF OUR PRODUCTS WILL BE FREE FROM ERRORS, DEFECTS, VIRUSES, OR OTHER HARMFUL ELEMENTS. ANY ADVICE,
              INFORMATION, OR STATEMENT THAT WE PROVIDE SHOULD NOT BE CONSIDERED AS CREATING ANY WARRANTY CONCERNING OUR
              PRODUCTS. WE DO NOT ENDORSE, GUARANTEE, OR ASSUME ANY RESPONSIBILITY FOR ANY ADVERTISEMENTS, OFFERS, OR
            ...
            <p>
              ...
              liabilities, costs, and expenses arising from: (a) your access and use of the Aave Umbrella interface; (b)
              your violation of any term or condition of this Agreement, the right of any third party, or any other
              applicable law, rule, or regulation; (c) any other party&apos;s access and use of Aave Umbrella interface
              with your assistance or using any device or account that you own or control; (d) any dispute between you
              and any other user of Aave Umbrella interface or any of your own customers or users; (e) your breach or
              alleged breach of the Agreement (including, without limitation, these Terms); (f) your violation of the
              rights of any third party, including any intellectual property right, publicity, confidentiality,
              property, or privacy right; (g) any misrepresentation made by you.
            </p>
            <p>
              We reserve the right to assume, at your expense, the exclusive defense and control of any matter subject
              to indemnification by you. You agree to cooperate with our defense of any claim. You will not in any event
            ...
            <h3 className="font-semibold">Agreement to Attempt to Resolve Disputes Through Good Faith Negotiations</h3>
            <p>
              ...
              within 90 days following the request for mediation or within such other period as the parties may agree in
              writing, such dispute shall thereafter be finally settled by way of arbitration according to the Rules of
              Arbitration of the International Chamber of Commerce (ICC) as detailed in Article 21.
            </p>
            ...
            <p>
              ...
              and the language of the arbitration shall be English. The arbitrator(s) must have experience adjudicating
              ...
              “Limitation of Liability” subsection of these Terms as to the types and amounts of damages for which a
              party may be held liable. The prevailing party will be entitled to an award of their reasonable attorney’s
              fees and costs. Except as may be required by law, neither a party nor its representatives may disclose the
            ...
            <p>
              ...
              “YOUR CHOICES”), YOU ACKNOWLEDGE AND AGREE THAT YOU AND WE ARE EACH WAIVING THE RIGHT TO A TRIAL BY JURY
              OR TO PARTICIPATE AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS ACTION OR REPRESENTATIVE
              PROCEEDING. FURTHER, UNLESS BOTH YOU AND WE OTHERWISE AGREE IN WRITING, THE ARBITRATOR MAY NOT CONSOLIDATE
              MORE THAN ONE PERSON’S CLAIMS AND MAY NOT OTHERWISE PRESIDE OVER ANY FORM OF ANY CLASS OR REPRESENTATIVE
              PROCEEDING.
            </p>
            <p>
              By rejecting any changes to these Terms, you agree that you will arbitrate any Dispute between you and us
              in accordance with the provisions of this section as of the date you first accepted these Terms (or
            ...
            <p>
              These Terms and any separate agreements whereby we provide you Services shall be governed by and construed
