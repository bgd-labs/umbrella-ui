      ...
      <ModalBody className="w-full max-w-(--mobile-container) md:max-w-[1000px]">
        ...
        >
          ...
          <div className="not-md:text-base mx-auto flex w-full md:max-w-[728px] flex-col gap-7 md:gap-9 md:pt-14 md:pb-[80px]">
            ...
            <p>
              Umbrella is an Aave system allowing stake Aave aTokens to earn
              rewards, but accepting risk of slashing to cover any deficit
            ...
            <div>
              <p>
                As commented, users can stake assets such as aUSDC into
                Umbrella, and receive rewards for taking on slashing risk.
              </p>
              ...
              <ul className="my-5 pl-6">
                <li className="relative">
                  ...
                  Users deposit their aTokens (e.g., aUSDC) into Umbrella, and
                  receive Umbrella stake aUSDC.
                </li>
                <li className="relative">
                  <span className="absolute -left-5 font-bold">2.</span>
                  <span className="mr-1 font-bold">Rewards Accumulation:</span>
                  While the user has its aUSDC staked on Umbrella, they still
                  earn yield from supplying on Aave, but also additional rewards
                  in one or multiple tokens, which may include AAVE, GHO, or
                  other assets, depending on the pool.
                </li>
                <li className="relative">
                ...
                <li className="relative">
                  ...
                  To withdraw staked assets, users must first initiate a
                  cooldown period that can last for example 20 days, depending
                  on Umbrella’s configuration. Once the cooldown period ends,
                  the user has a withdrawal window to complete the withdrawal,
                  also depending on Umbrella’s configuration, but for example of
                  2 days.
                </li>
              </ul>
              <p>
                This structured process ensures that withdrawals are orderly and
                prevents sudden spikes in unstaking, which could potentially
            ...
            <ul className="pl-6">
              <li className="relative mb-4">
                ...
                This interface is non-custodial: it allows users to connect
                their wallet applications, building transactions to be submitted
                to the Umbrella smart contracts.
              </li>
              <li className="relative mb-4">
                <span className="absolute -left-5 font-bold">&bull;</span>
                All configurations of Umbrella are based on smart contracts
                controlled by the Aave decentralized governance. This means that
                over time, aspects like rewards, cooldown period, withdrawal
                window, or even assets available to stake depend solely and
                exclusively on the Umbrella smart contracts, not anyhow on this
                interface.
              </li>
              <li className="relative mb-4">
                <span className="absolute -left-5 font-bold">&bull;</span>
                The Umbrella system of smart contracts this interface connects
                is based on a principle of risk and reward:{" "}
                <span className="font-bold">
                  if you are a user staking in Umbrella and a deficit is accrued
                  on the connected asset on the Aave pool, you can potentially
                  be slashed.
                </span>{" "}
                By interacting with the Umbrella contract, you explicitly accept
                this risk and any consequences arising from it, including
