        ...
        <Block elevation={isMobile ? 1 : 2} className="relative px-0 not-md:py-5">
          ...
          <div className="h-full max-h-[90vh] overflow-y-auto px-6 md:px-0">
            <div className="mx-auto flex w-full flex-col gap-7 not-md:text-base md:max-w-[728px] md:gap-9 md:pt-14 md:pb-[80px]">
              ...
              <p>
                Umbrella is an Aave system allowing stake Aave aTokens to earn rewards, but accepting risk of slashing
                to cover any deficit accrued on the Aave pools.
              </p>
              ...
              <div>
                ...
                <ul className="my-5 pl-6">
                  ...
                  <li className="relative">
                    ...
                    days, depending on Umbrella’s configuration. Once the cooldown period ends, the user has a
                    withdrawal window to complete the withdrawal, also depending on Umbrella’s configuration, but for
                    example of 2 days.
                  </li>
                </ul>
                <p>
              ...
              <ul className="pl-6">
                ...
                <li className="relative mb-4">
                  ...
                  governance. This means that over time, aspects like rewards, cooldown period, withdrawal window, or
                  even assets available to stake depend solely and exclusively on the Umbrella smart contracts, not
                  anyhow on this interface.
                </li>
                <li className="relative mb-4">
                  <span className="absolute -left-5 font-bold">&bull;</span>
                  ...
                  By interacting with the Umbrella contract, you explicitly accept this risk and any consequences
                  arising from it, including earning rewards as compensation for assuming the risk.
                </li>
              </ul>
