export const REWARDS_CONTROLLER_ABI = [
  ...
  { inputs: [], name: "InvalidMaxEmissionPerSecond", type: "error" },
  {
    inputs: [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "targetLiquidity", type: "uint256" },
      {
        components: [
          { internalType: "address", name: "reward", type: "address" },
          { internalType: "address", name: "rewardPayer", type: "address" },
    ...
    outputs: [
      {
        components: [
          { internalType: "uint256", name: "targetLiquidity", type: "uint256" },
          { internalType: "uint256", name: "targetLiquidityExcess", type: "uint256" },
          { internalType: "uint256", name: "maxEmission", type: "uint256" },
          { internalType: "uint256", name: "flatEmission", type: "uint256" },
        ],
